<template>
    <div>
       <div class="jumbotron">
        ...
        <div class="row">
            <div class="col-md-9">
                <h1 class="alert alert-info">Acquisition du coupons</h1>
                ...
                <button  v-show="!successMessage" class="btn btn-primary" :disabled="disableSubmit" @click="performSubmit">Acquerir ce coupon </button>
                ...
                <div v-show="successMessage" class="alert alert-success mt-3" role="alert">
                    <strong>Vous avez acquis ce coupon!</strong>
    ...
    export default {
        ...
        methods: {
            ...
            performCouponRegistration(address) {
                    ...
                    window.bc.contract('Users').transfer(
                        this.couponId,
                        address,
                        {
                            from: address,
