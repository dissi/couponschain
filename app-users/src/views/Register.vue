        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Entrez votre nom" type="text" v-model="userName">
                </div>

                <div class="form-group">
	            
                    <label for="Categorie">Categorie d'utilisateur</label>
    ...
    export default {
        ...
        methods: {
            ...
            performUserRegistration(address) {
                window.bc.contract('Users').registerUser(
                    this.userName,
                    this.userStatus,
                    {
                        from: address,
