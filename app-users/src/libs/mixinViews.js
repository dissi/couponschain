    ...
    methods: {
        ...
        init() {
            ...
            if (window.bc == undefined) {
                ...
                window.bc.initWithContractJson(UsersContract, 'http://127.0.0.1:7545','Users')
                .then((error) => {
                    ...
                    if (error) {
                        ...
                        window.bc.initWithContractJson(ProduitsContract, 'http://127.0.0.1:7545','Produits');
                       // console.log('Total Produits: ' + this.countContracts());
                        this.isRegistered()
                        .then(res => {
        ...
        countContracts() {
            return window.bc.countContracts();
        },
        /**
